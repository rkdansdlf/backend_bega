...
public interface ActivePowerupRepository extends JpaRepository<ActivePowerup, Long> {
    ...
    List<ActivePowerup> findActiveByUserId(@Param("userId") Long userId, @Param("now") Instant now);
    ...
    int deleteOldUsedPowerups(@Param("before") Instant before);
